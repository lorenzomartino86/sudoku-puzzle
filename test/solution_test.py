...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    solved_complex_diag_sudoku = {'D2': '5', 'G8': '8', 'E4': '3', 'F5': '8', 'A7': '9', 'D1': '6', 'A8': '5',
                                  'H9': '3', 'H5': '7', 'H7': '5', 'I4': '4', 'D6': '4', 'G2': '7', 'H6': '8',
                                  'D4': '2', 'D5': '9', 'F3': '9', 'A4': '8', 'C4': '5', 'D7': '3', 'A9': '6',
                                  'A1': '7', 'G3': '1', 'H1': '2', 'F7': '6', 'B4': '9', 'F1': '3', 'I2': '3',
                                  'C6': '7', 'B6': '2', 'F9': '5', 'C9': '8', 'G1': '5', 'C2': '6', 'I6': '5',
                                  'B7': '1', 'E8': '9', 'D3': '8', 'E2': '2', 'I3': '6', 'C7': '2', 'B9': '7',
                                  'G7': '4', 'I5': '2', 'I9': '9', 'G9': '2', 'G6': '9', 'B8': '3', 'I8': '1',
                                  'I1': '8', 'H8': '6', 'F4': '7', 'A2': '1', 'E6': '6', 'G5': '3', 'H2': '9',
                                  'G4': '6', 'B3': '5', 'C8': '4', 'C3': '3', 'B5': '6', 'H3': '4', 'E1': '1',
                                  'F6': '1', 'A6': '3', 'B2': '8', 'C5': '1', 'D9': '1', 'E3': '7', 'I7': '7',
                                  'C1': '9', 'A5': '4', 'A3': '2', 'H4': '1', 'E7': '8', 'E5': '5', 'F8': '2',
                                  'F2': '4', 'E9': '4', 'D8': '7', 'B1': '4'}

    def test_solve(self):
        self.assertEqual(solution.solve(self.diagonal_grid), self.solved_diag_sudoku)

    def test_solve_complex_grid(self):
        self.assertEqual(solution.solve(self.complex_diagonal_grid), self.solved_complex_diag_sudoku)
